...
export function TabiqueSuperboardView() {
  ...
  const results = useMemo(() => calcTabiqueSuperboard(area * (1 + wastePct / 100)), [area, wastePct]);

  const shareWhatsApp = () => {
    const text = [
      'Tabique Superboard — ' + area + ' m²',
    ...
    <article className={styles.card}>
      ...
      <div className={styles.body}>
        <div className={styles.left}>
          ...
          <div className={styles.formatCard}>
            ...
            <div className={styles.formatBody}>
              <h3>Plancha Superboard {PLANCHA_FACTOR_M2} m²</h3>
              <span className={styles.tag}>Sistema multicapa</span>
            </div>
          ...
          <div className={styles.infoBlue}>
            ...
            <span>Cerramientos exterior/interior · fachada · transiciones</span>
          </div>
          ...
          <div className={styles.tipCard}>
            <div className={styles.tipHead}>
              ...
              <div>
                ...
                <p>El sistema Superboard requiere sellador Sika en juntas. Incluye este material en tu cotización.</p>
              </div>
            </div>
            <span className={styles.pillIncluded}>
              <IconCheck /> ¡Incluye Sika!
            </span>
          </div>
        ...
        <div className={styles.right}>
          ...
          {results ? (
            <TablaResultadoSuperboard {...results} />
          ) : (
