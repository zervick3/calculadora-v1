    ...
    <article className={styles.card}>
      ...
      <div className={styles.body}>
        <div className={styles.left}>
          <p className={styles.stepLabel}>Paso 1 · Ingresa el área del cielo raso</p>
          <div className={styles.inputsRow}>
            <div className={styles.field}>
              <label htmlFor="cielo-area">Superficie (m²)</label>
          ...
          <div className={styles.infoBlue}>
            ...
            <span>Techo registrable · plafón · estructura colgante</span>
          </div>
          ...
          <div className={styles.tipCard}>
            <div className={styles.tipHead}>
              ...
              <div>
                ...
                <p>Para cielo raso usa mayor densidad de parantes (1,1×m²) para mejor soporte de la gravedad.</p>
              </div>
            </div>
            <span className={styles.pillIncluded}>
              <IconCheck /> ¡Estructura reforzada!
            </span>
          </div>
          ...
          <div className={styles.tech}>
            ...
            <ul>
              ...
              <li>Coeficientes: parante 1,1×m², riel 0,35×m²</li>
            </ul>
          </div>
          ...
          <details className={styles.advanced}>
            ...
            <div className={`${styles.field} ${styles.wasteField}`}>
              <label htmlFor="cielo-waste">Desperdicio (%)</label>
              <div className={styles.inputWrap}>
                <input
                  id="cielo-waste"
                  type="number"
        ...
        <div className={styles.right}>
          ...
          {results ? (
            <TablaResultadoCieloRaso {...results} />
          ) : (
