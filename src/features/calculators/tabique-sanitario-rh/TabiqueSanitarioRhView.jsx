...
export function TabiqueSanitarioRhView() {
  ...
  return (
    <article className={styles.card}>
      <header className={styles.header}>
        <h1>Tabique sanitario RH</h1>
        <p className={styles.subtitle}>
          <span className={styles.dot} />
          Interior — zonas húmedas
          <span className={styles.dot} />
        </p>
      </header>
        ...
        <div className={styles.left}>
          ...
          <div className={styles.formatCard}>
            ...
            <div className={styles.formatBody}>
              <h3>Plancha RH {PLANCHA_FACTOR_M2} m²</h3>
              <span className={styles.tag}>Resistente a humedad</span>
            </div>
          ...
          <div className={styles.infoBlue}>
            ...
            <span>Zonas húmedas · baño · cocina · lavandería</span>
          </div>
          ...
          <div className={styles.tipCard}>
            <div className={styles.tipHead}>
              ...
              <div>
                ...
                <p>Las planchas RH抵抗en la humedad. Se usan junto con estructura galvanizada para zonas sanitarias.</p>
              </div>
            </div>
