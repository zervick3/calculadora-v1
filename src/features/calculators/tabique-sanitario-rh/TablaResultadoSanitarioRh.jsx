import styles from './TablaResultadoSanitarioRh.module.css';

const ROWS = [
  { key: 'Planchas', label: 'Planchas estándar' },
  { key: 'Plancharh', label: 'Planchas RH' },
  ...
  return (
    <div className={styles.wrap}>
      ...
      <p className={styles.note}>
        ...
        <code className={styles.code}>calcTabiqueSanitarioRh.js</code> si tu sistema usa otros coeficientes.
      </p>
    </div>
  );
}